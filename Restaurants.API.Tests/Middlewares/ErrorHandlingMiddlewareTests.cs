...
namespace Restaurants.API.Middlewares.Tests
{
    public class ErrorHandlingMiddlewareTests
    {
        ...
        public async Task InvokeAsync_WhenNoExceptionThrown_ShouldCallNextDelegate()
        {
            ...
            var errorHandleingMiddleware = new ErrorHandlingMiddleware(loggerMock.Object);
            var context = new DefaultHttpContext();
            var nextDelegateMock = new Mock<RequestDelegate>();

            //act
           await errorHandleingMiddleware.InvokeAsync(context, nextDelegateMock.Object);

            //assert 

            nextDelegateMock.Verify(t=>t.Invoke(context),Times.Once);
        }
